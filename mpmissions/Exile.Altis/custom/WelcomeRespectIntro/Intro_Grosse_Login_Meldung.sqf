...
[parseText format["<t size='0.6'font='OrbitronLight' color='#ffffff'>. . . . Herzlich Willkommen %1 . . . .</t><br/><t size='0.6'font='OrbitronLight' color='#908EAA'>. . . . Dies is ein ONLY PVE Server der ChaosKatastrophe . . . .</t>",name player,_level],0,1,30,0] spawn bis_fnc_dynamictext;
